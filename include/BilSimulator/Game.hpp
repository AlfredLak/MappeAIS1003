...
class Game {
public:
    Game(threepp::Canvas* canvas, threepp::GLRenderer* renderer, threepp::Scene* scene, threepp::PerspectiveCamera* camera,
         threepp::Object3D* carRoot, threepp::Object3D* chassis, const std::vector<threepp::Object3D*>& wheels,
    ...
    // collision response (tilt + stop + snap back)
...
private:
    threepp::Canvas* canvas_; threepp::GLRenderer* renderer_; threepp::Scene* scene_; threepp::PerspectiveCamera* camera_;
    threepp::Object3D* carRoot_; InputState* input_; PowerUpManager* powerUps_; Trees* trees_;

    VehiclePhysics physics_;
    VehicleVisuals visuals_;
    CameraController cameraController_;

    threepp::Clock clock_; double lastTime_{0.0};
...
// ---- Inline glue for PowerUps and Trees now that Game is known ----
...
inline void Trees::onCollision(Game& g, float speed){
    g.onCollision(speed);
}
